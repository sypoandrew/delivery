...
class CreateSypoBondedWarehouseAddress extends Migration
{
    ...
    public function up()
    {
        ...
        \DB::table('sypo_bonded_warehouse_address')->insert(array('name' => 'VinQuinn', 'first' => 'VinQuinn', 'last' => 'VinQuinn', 'line1' => 'The Old Tannery', 'line2' => 'Oakdene Road', 'city' => 'Redhill', 'county' => 'Surrey', 'postcode' => 'RH1 6BT', 'country_code' =>'GB', 'created_at' => \Carbon\Carbon::now()));
        \DB::table('sypo_bonded_warehouse_address')->insert(array('name' => 'LCB Tilbury', 'first' => 'LCB', 'last' => 'Tilbury', 'line1' => '29-30 Berths', 'line2' => 'Tilbury Freeport', 'city' => 'Tilbury', 'county' => 'Essex', 'postcode' => 'RM18 7EH', 'country_code' =>'GB', 'created_at' => \Carbon\Carbon::now()));
        \DB::table('sypo_bonded_warehouse_address')->insert(array('name' => 'LCB Vinotheque', 'first' => 'LCB', 'last' => 'Vinotheque', 'line1' => 'Derby Road', 'line2' => '', 'city' => 'Burton-Upon-Trent', 'county' => 'Staffordshire', 'postcode' => 'DE14 1RY', 'country_code' =>'GB', 'created_at' => \Carbon\Carbon::now()));
        \DB::table('sypo_bonded_warehouse_address')->insert(array('name' => 'LCB Dinton Woods', 'first' => 'LCB', 'last' => 'Dinton Woods', 'line1' => 'Catherine Ford Lane', 'line2' => '', 'city' => 'Salisbury', 'county' => 'Wiltshire', 'postcode' => 'SP3 5HB', 'country_code' =>'GB', 'created_at' => \Carbon\Carbon::now()));
